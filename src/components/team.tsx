...
const members = [
  {
    ...
    role: "CEO",
    motto: "「現代の松下村塾をつくる」",
    bio: "兵庫県神戸市出身。広島大学経済学部在学中、キャリア支援NPOの広島支部立ち上げを主導し、3名の組織を15名規模に拡大、年間300名の地方大学生にキャリアの入口を届ける。2021年、新卒入社した東証一部上場企業を1ヶ月で退職し独立、同年に広島で若者起業家シェアハウス「もみじ」を創業し、累計200名超の大学生が全国から集う拠点を築く。2022年より東京・大阪・福岡で展開される審査制エンタメ教育コミュニティ『Amuse!』に経営参画し、北海道支部のゼロイチ立ち上げを担う。2023年よりZeronity株式会社コンサルタントとして、外資系製薬会社の新規ヘルスケアサービス立ち上げ（コンセプト検証〜GTM戦略）、大手自動車メーカーグループ新規事業のプロジェクトリーダー（281自治体の施策データベース構築）、大手LEDサインメーカーの人事制度改革PMO（約1年）など、調査・設計・実行を一気通貫で担う新規事業開発に従事。2024年に株式会社サムライウタリを設立し、「人づくり・場づくり・事業づくり」の3軸で現在取り組んでいる。",
