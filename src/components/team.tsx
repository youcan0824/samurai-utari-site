...
const members = [
  {
    ...
    role: "CEO",
    motto: "「現代の松下村塾をつくる」",
    bio: "兵庫県神戸市生まれ。2021年広島大学経済学部卒業後、東証一部上場企業を1ヶ月で退職し独立。「人づくり・場づくり・事業づくり」を軸に活動。2020年キャリア支援NPO広島支部立ち上げ（3名→15名、年間300名の大学生にキャリア教育を届ける）、2021年若者起業家シェアハウス「もみじ」創業（累計200名超）、2022年エンタメ教育コミュニティ『Amuse!』北海道支部立ち上げ。2023年よりZeronity株式会社コンサルタントとして、外資系製薬会社の新規ヘルスケアサービス立ち上げ（コンセプト検証〜GTM戦略）、大手自動車メーカーグループ新規事業のPL（281自治体DB構築）、大手LEDサインメーカーの人事制度改革PMO（約1年）等に従事。2024年株式会社サムライウタリを設立し現在に至る。",
