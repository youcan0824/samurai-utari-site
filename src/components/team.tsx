...
const members = [
  ...
  },
  {
    ...
    role: "COO",
    motto: "「ポテンシャルを解放する」",
    bio: "兵庫県神戸市出身。大学在学中に学生向けのキャリア開発コミュニティを創業、累計会員数112名を擁し、楽天・リクルート・デロイト・P&Gなど大手企業に人材を輩出。2018年、高校生キャリア雑誌を創業し、クラウドファンディングとオンラインサロンで資金を集め、5,000名の高校生に届ける。翌2019年には起業家シェアハウスを創業、累計20名超の若者が入居する拠点を築く。自身の強みを活かせる領域を見つけることが幸せに生きる鍵であるとの気づきから、2021年にコーチング事業を開始、学生・社会人・経営者など多様な領域の人材のポテンシャル解放に従事。2022年より地方創生文脈での土着企業コンサルティング、2023年にはアントレプレナーシッププログラムの提供を開始。現在は株式会社Armory・株式会社PLOWNOWの役員も兼務し、経営に従事している。",
