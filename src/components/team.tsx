...
const members = [
  {
    ...
    role: "CEO",
    motto: "「現代の松下村塾をつくる」",
    bio: "兵庫県神戸市生まれ、広島大学経済学部卒。新卒で東証一部上場企業に入社するも1ヶ月で退職し独立。学生時代にキャリア支援NPOの広島支部立ち上げを主導、3名から15名の組織へと育て上げ、年間300名の地方大学生にキャリアの入口を届ける。2021年、広島に若者起業家シェアハウス「もみじ」を創業、累計200名超の大学生が全国から集う拠点となる。その後、東京・大阪・福岡に展開する審査制エンタメ教育コミュニティに経営参画。現在は東京のスタートアップ支援ファームZeronityで戦略・BPOコンサルティングを手掛けながら、北海道を拠点に「現代の松下村塾」を構想中。29歳、まだ途中。",
