...
const members = [
  {
    ...
    role: "CEO",
    motto: "「現代の松下村塾をつくる」",
    bio: "兵庫県神戸市生まれ、広島大学経済学部卒。新卒で東証一部上場企業を1ヶ月で退職し独立。以降「人づくり・場づくり・事業づくり」の3軸で実績を重ねる。キャリア支援NPOの広島支部を3名から15名へ拡大、年間300名の地方大学生にキャリアの入口を届け、若者起業家シェアハウス「もみじ」を創業（累計200名超）。東京のスタートアップ支援ファームZeronityでは、外資系製薬会社の新規ヘルスケアサービスのコンセプト検証〜GTM戦略立案、大手自動車メーカーグループ新規事業のPL（281自治体の施策データベース構築を統括）、大手LEDサインメーカーの人事制度改革（約1年のPMO）など、調査・設計・実行を一気通貫で担当。現在は札幌を拠点に、都市部の大企業で磨いたフレームを北海道のサイズに翻訳し、道内の企業・自治体・大学と現場で噛み砕きながら伴走している。29歳、まだ途中。",
