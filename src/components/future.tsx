...
export function Future() {
  return (
    <section className="relative py-[160px] md:py-[220px] px-6 md:px-[60px] bg-[#faf8f3] overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-start">
          <ScrollFadeIn>
            ...
            >
              サムライウタリを、
              <br />
              <span className="text-[#8b2500]">地方から。</span>
            </h2>
          </ScrollFadeIn>
          ...
          <ScrollFadeIn>
            ...
            >
              ...
              <p>
                理想を生きる人を「サムライ」、志を同じくする同胞を「ウタリ」と呼ぶ。志を同じくする者たちが集い、互いを高め合う場をつくることが、私たちのミッション。
              </p>
              <p>
